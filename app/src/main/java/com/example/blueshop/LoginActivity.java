...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bCon = (Button) findViewById(R.id.btnConf);
        bVeri = (Button) findViewById(R.id.btnVerify);
        ...
        bVeri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    Toast.makeText(LoginActivity.this, "Ingrese numero telefonico por favor", Toast.LENGTH_SHORT).show();
                }else{
                    ...
                    PhoneAuthOptions options = PhoneAuthOptions.newBuilder(auth).setPhoneNumber(phoneNumber).setTimeout(60L, TimeUnit.SECONDS)
                            .setActivity(LoginActivity.this).setCallbacks(callbacks).build();
        ...
        bCon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(veriCodigo)){
                    Toast.makeText(LoginActivity.this, "Ingrese el codigo enviado por favor", Toast.LENGTH_SHORT).show();
                }else{
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                dialog.dismiss();
                Toast.makeText(LoginActivity.this, "Fallo el Inicio de Sesion. Causas:\n" +
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                dialog.dismiss();
                Toast.makeText(LoginActivity.this, "Codigo enviado correctamente," +
